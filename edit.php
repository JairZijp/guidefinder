	...
	<div class="row">
	    ...
	    <div class="col-xs-12 col-sm-12 col-md-12">
				...
				<form method="post" enctype="multipart/form-data">
					<div class="col-md-5">
						<a href="memberpage.php">Cancel</a>
						...
						<b>Profile picture<b><br>
							<img height="100" width="100" src="images/profile/<?= $info['image']; ?>">
							<input class="btn" type="file" accept="image/*" id="image" name="image"></p>
	                	<div class="row">
							<div class="col-xs-6 col-md-6"><input type="submit" name="submit" value="Update Profile" class="btn btn-primary btn-block btn-lg" tabindex="5"></div>
						</div>
					</div>
					<div class="col col-xs-12 col-sm-6 col-md-6 col-lg-6">
						...
						<div class="col-xs-12 col-sm-12 col-md-12">
							<div class="form-group">
								<b>About</b>
								<textarea name="description" id="description" value="<?= $info['description'] ?>" class="form-control input-lg"><?= $info['description'] ?></textarea>
							</div>
						</div>
	                </div>
                </form>
